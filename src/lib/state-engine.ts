...
export const initialGameState: GameState = {
  ...
  inventory: [],
  roomDescription: `48시간 전, 미술관 큐레이터 김예린이 의문사했습니다. 경찰은 단순 사고사로 결론지었지만, 당신은 정부 소속 비밀 요원으로서 그녀가 국제 예술품 밀매 조직과 연관되어 있었다는 정보를 입수했습니다.
오늘 밤, 당신은 그녀의 개인 서재에 잠입하여 증거를 찾던 중 결정적 단서를 발견했습니다. 그런데 갑자기 삐삐삐! 경보음이 울리며 금속문이 자동으로 봉쇄되었습니다.
이어폰에서 본부의 긴급 메시지가 들려옵니다:
"요원, 적대 세력이 접근 중이다. 김예린의 죽음과 관련된 핵심 증거가 벽의 디지털 금고 안에 있을 것이다. 15분 안에 증거를 확보하고 탈출하라. 잡히면 우리는 당신을 모른다."
벽의 금고는 4자리 비밀번호로 잠겨있고, 김예린이 남긴 암호화된 메시지들이 서재 곳곳에 숨겨져 있을 것입니다. 시간이 촉박합니다!`,
  lastMessage: null,
  isEscaped: false,
  player: {
    abilities: ['관찰', '추론'],
